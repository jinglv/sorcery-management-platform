...
class Envs(models.Model):
    ...
    * base_url = seldom.main(base_url="xxx")  # http接口测试：指定当前运行的URL xxx=http://www.httpbin.org
    ...
    name = models.CharField("环境名称", max_length=50, null=False)
    env = models.CharField("环境值", max_length=50, null=True, default="")
    browser = models.CharField("浏览器", max_length=20, null=True, default="")
    protocol = models.CharField("URL", max_length=200, null=True, default="")
