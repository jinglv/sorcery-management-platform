  ...
  >
    ...
    >
      ...
      <el-form-item label="类型">
        <el-input v-model="suiteRunForm.type" :disabled="true" />
      </el-form-item>
...
<script>
import { httpRunnerProjectList, httpRunnerRunSuite } from '@/api/httprunner'
...
export default {
  ...
  methods: {
    ...
    async httpRunnerRunSuite() {
      this.suiteRunForm.httprunner_project_id = this.projectValue
      this.suiteRunForm.env_url = this.envValue
      this.suiteRunForm.suite_ids = this.ids
      this.loading = true
      const resp = await httpRunnerRunSuite(this.suiteRunForm)
      if (resp.success === true) {
